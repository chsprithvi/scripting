public class EmpWageArray {
	...
	public static void main(final String[] args) {
		final EmpWageBuilderArray companyObj = new EmpWageBuilderArray();
...
class EmpWageBuilderArray {
	...
	private final Company[] wageArray;
    ...
    public void printEmpWage() {
		for (int i = 0; i < companyCount; i++) {
			wageArray[i].setTotalEmpWage(EmpWageBuilderArray.computeEmpWage(wageArray[i]));
